...
class Auth
{
    ...
    public function getGroups($uid)
    {
        ...
        $user_groups = M()->getAll("SELECT a.uid,a.group_id,g.title,g.rules FROM {$this->_config['AUTH_GROUP_ACCESS']} a INNER JOIN {$this->_config['AUTH_GROUP']} g on a.group_id=g.id  WHERE ( a.uid=:uid and g.status=:status )", ['uid' => $uid, 'status' => '1']);
